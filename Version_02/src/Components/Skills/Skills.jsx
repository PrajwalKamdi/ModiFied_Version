...
function Skills() {
  return (
    <>
      <main id="skills" className="p-3 md:px-10 lg:px-16 xl:px-20  2xl:px-32">
        <section>
          ...
          <div className="grid sm:p-3 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-4 xl:grid-cols-4 2xl:grid-cols-4 gap-10 ">
            ...
            <div className=" p-5 md:p-5 2xl:p-10 xl:p-5 lg:p-5 rounded-m shadow-2xl hover:scale-110 duration-500">
              ...
              <div>
                <h3 className="font-semibold capitalize">
                  Proficient in java language and having more than 3+
                  years of experience in java world
                </h3>
              </div>
            </div>
            <div className="flex flex-col justify-between  p-5 md:p-5 2xl:p-10 xl:p-5 lg:p-5 rounded-md shadow-2xl hover:scale-110 duration-500">
             <div>
             <img src={spring} alt="" className="rounded-md" />
             </div>
              <div>
                <h3 className="font-semibold capitalize"> Competent in backend developement with spring,
                springboot, and MYSQL database</h3>
              </div>
            </div>
            <div className="flex flex-col justify-between  p-5 md:p-5 2xl:p-10 xl:p-5 lg:p-5 rounded-md shadow-2xl hover:scale-110 duration-500">
              <div className="mt-10"><img src={tailwind} alt="" className="rounded-md " /></div>
              <div>
                <h3 className="font-semibold capitalize">Skilled in tailwind css utility framework and can develope the fully responsive web application</h3>
              </div>
            </div>
          </div>
        </section>
